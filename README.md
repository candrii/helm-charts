...
|-------|---------|-------------|
| [argocd-victoriametrics-stack](charts/argocd-victoriametrics-stack/) | 1.2.8 | ArgoCD Application to deploy Victoria Metrics stack with operator |
...
| [olmv1](charts/olmv1/) | 0.1.4 | A Helm chart for OLMv1 |
| [teamcity-server](charts/teamcity-server/) | 0.3.0 | JetBrains TeamCity CI/CD server |
