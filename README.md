...
|-------|---------|-------------|
| [argocd-victoriametrics-stack](charts/argocd-victoriametrics-stack/) | 1.2.10 | ArgoCD Application to deploy Victoria Metrics stack with operator |
...
| [olmv1](charts/olmv1/) | 0.1.5 | A Helm chart for OLMv1 |
| [teamcity-server](charts/teamcity-server/) | 0.5.1 | JetBrains TeamCity CI/CD server |
| [teamcity-tests-agents](charts/teamcity-tests-agents/) | 0.3.0 | TeamCity test agents with auto-authorization |
