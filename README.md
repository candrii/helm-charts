...
|-------|---------|-------------|
| [argocd-victoriametrics-stack](charts/argocd-victoriametrics-stack/) | 1.2.11 | ArgoCD Application to deploy Victoria Metrics stack with operator |
...
| [teamcity-tests-agents](charts/teamcity-tests-agents/) | 0.5.0 | TeamCity test agents with auto-authorization |
